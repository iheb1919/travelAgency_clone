              ...
              <div className='flex flex-col gap-5' >
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-2'>
                  <div className='overflow-hidden rounded-lg'>
                    <LazyImage className='rounded-lg hover:scale-110  transition-all duration-500' src="/travelAgency_clone/tours/maldives2.jpg" alt="" />
                  </div>
                  <div className='overflow-hidden rounded-lg'>
                    <LazyImage className='rounded-lg hover:scale-110  transition-all duration-500' src="/travelAgency_clone/tours/maldives3.jpg" alt="" />
                  </div>
                  <div className='overflow-hidden rounded-lg'>
                    <LazyImage className='rounded-lg hover:scale-110  transition-all duration-500' src="/travelAgency_clone/tours/maldives4.jpg" alt="" />
                  </div>
...
export const TourDetailsHeader = () => {
  ...
  const sliderImages = [
    "bg-[url('/slider/15.jpg')]",
    "bg-[url('/slider/16.jpg')]",
    "bg-[url('/slider/17.jpg')]",
  ]
  return (
      ...
      <Slider {...settings}>
        {
          sliderImages.map((img, i) => <div key={i}
            data-overlay-dark="2"
            className={`h-screen w-full ${img} !mx-[-5px] bg-cover  bg-center`}
          ></div>)
        }
